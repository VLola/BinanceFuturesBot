...
namespace BinanceFuturesBot.ViewModels
{
    public class BetViewModel
    {
        ...
        private void ShowChart()
        {
            ...
            DateTime startTime = BetModel.Time.AddMinutes(-30 * 5);
            DateTime endTime = BetModel.Time.AddMinutes(30 * 5);

            int interval = 5;
            if (BetModel.Interval == KlineInterval.FifteenMinutes) {
                interval = 15;
                startTime = BetModel.Time.AddMinutes(-30 * 15);
                endTime = BetModel.Time.AddMinutes(30 * 15);
            }
